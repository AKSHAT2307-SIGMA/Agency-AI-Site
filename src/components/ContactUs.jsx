...
const ContactUs = () => {
    ...
    formData.append("access_key", "e9ae78fb-a570-4d31-a5a7-0495e1885076");
  ...
  return (
    ...
    dark:text-white'>
        ...
        <form onSubmit = {onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
            ...
            <button type="submit" className='w-max gap-2 bg-primary text-white
            text-sm px-10 py-3 rounded-full cursore-pointer hover:scale-103
            transition-all'>
