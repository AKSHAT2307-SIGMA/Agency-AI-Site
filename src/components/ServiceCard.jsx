...
const ServiceCard = ({service, index}) => {
  ...
  return (
    <div ref = {divRef} className='relative overflow-hidden max-w-lg m-2 sm:m-4 rounded-xl border
    ...
    onMouseMove={handleMouseMove}>
        ...
        <div className={`pointer-events-none blur-2xl ounded-full bg-gradient-to-r
