...
import AkshatSaxena from './AkshatSaxena.jpeg'
import divvu from './divvu.png'
import aish from './aish.png'
import didah from './didah.png'
import aditi from './aditi.png'
import suiti from './suiti.png'
...
export const teamData = [
  { name: 'Akshat Saxena', title: 'CEO & founder', image: AkshatSaxena },
  { name: 'Harshita Saxena', title: 'Ads manager', image: didah },
  { name: 'Shruti Saxena', title: 'Vice president', image: suiti },
  { name: 'Akshara Saxena', title: 'Marketing & sales', image: divvu },
  { name: 'Aditi', title: 'Content marketer', image: aditi },
  { name: 'Aish Singh', title: 'Content writer', image: aish },
